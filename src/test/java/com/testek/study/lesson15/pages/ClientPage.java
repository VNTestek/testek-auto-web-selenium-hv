package com.testek.study.lesson15.pages;


import com.testek.study.lesson15.common.BasePage;
import com.testek.study.lesson15.common.LogType;
...
public class ClientPage extends BasePage {
    ...
    public void verifyClientDashboard() {
        ...
        BasePage.addReportInfo(LogType.VERIFY, "Verify Total Client");
        ...
        BasePage.addReportInfo(LogType.VERIFY, "Verify Total contacts");
        ...
        BasePage.addReportInfo(LogType.VERIFY, "Verify Clients has unpaid invoices");
    }
