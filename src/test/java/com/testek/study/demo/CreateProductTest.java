...
public class CreateProductTest {
    private final String baseURL = "https://testek.vn/lab/auto/login";
     ...
     **/
    @Test(description = "Create a product")
    public void ProductMng_Add_New_Product_001() {
        // Truy cập website
        gotoDemoQAWebsite();
