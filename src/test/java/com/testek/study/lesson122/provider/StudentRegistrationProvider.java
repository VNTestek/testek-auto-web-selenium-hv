package com.testek.study.lesson122.provider;
...
public class StudentRegistrationProvider {
    ...
    public Object[][] DemoQA_Registration_Data(Method method) {
        ...
        String dataFile = System.getProperty("user.dir") + File.separator + "src/test/java/lession12/data/studentFormData.json";
